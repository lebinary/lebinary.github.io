...
experience = pd.read_csv("experience.tsv", sep="\t", header=0)
experience
...
for row, item in experience.iterrows():
    ...
    with open("../experience/" + md_filename, 'w') as f:
        f.write(md)


# These files are in the experience directory, one directory below where we're working from.
